...
def main(argv):
    ...
    global img
    global templ
    img = cv.imread('/home/rodion/yuliia0/aboba/cv/histo/cat2.png')
    templ = cv.imread('/home/rodion/yuliia0/aboba/cv/histo/templ.jpg')

    if (len(sys.argv) > 3):
        global use_mask
        use_mask = True
        global mask
        mask = cv.imread( '/home/rodion/yuliia0/aboba/cv/histo/templ.jpg' )
