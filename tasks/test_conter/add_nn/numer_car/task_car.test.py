...
img = cv2.imread('/home/rodion/yuliia0/aboba/tasks/task8/numer_car/car_numer2.jpg')
...
canny= cv2.Canny(gray, 260, 260 * 2)
...
text = pytesseract.image_to_string(thresh, lang='eng',config='stdout -c tessedit_char_whitelist=0123456789')
print ("text-",text)

only_number = re.findall(r'\d', text)
only_number = ' '.join(map(str, only_number))
print('only_number',only_number)
