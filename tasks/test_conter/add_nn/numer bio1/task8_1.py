...
img = cv2.imread('/home/rodion/yuliia0/aboba/tasks/task8/numer bio1/lich1.jpg')
...
canny= cv2.Canny(gray, 340, 340 * 2)
...
for i in range(len(contours)):
    ...
    if 8*(boundRect[i][3])>boundRect[i][2] and 2*(boundRect[i][3])<boundRect[i][2]:
