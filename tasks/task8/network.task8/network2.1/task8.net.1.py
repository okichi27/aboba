...
import numpy as np
'''
numberPlateCascade = cv2.CascadeClassifier('haarcascade_frontalface_default.xml') 
plat_detector =  cv2.CascadeClassifier(cv2.data.haarcascades + "haarcascade_frontalface_default.xml")
img = cv2.imread('/home/rodion/yuliia0/aboba/tasks/task8/numer_car/car_numer1.jpg')
#gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

plates = plat_detector.detectMultiScale(image=img, scaleFactor=1.2, minNeighbors=5, minSize=(25,25)) 
